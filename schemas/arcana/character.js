...
export default [
  ...
  {
    name: 'positiveAspectM',
    title: 'Positive Aspect (Male)',
    type: 'array',
    of: [{type: 'block'}],
    group,
    description: 'Positive aspects specific to males of this energy type',
  },
  {
    name: 'positiveAspectF',
    title: 'Positive Aspect (Female)',
    type: 'array',
    of: [{type: 'block'}],
    group,
    description: 'Positive aspects specific to females of this energy type',
  },
  {
  ...
  {
    name: 'negativeAspectM',
    title: 'Negative Aspect (Male)',
    type: 'array',
    of: [{type: 'block'}],
    group,
    description: 'Negative aspects specific to males of this energy type',
  },
  {
    name: 'negativeAspectF',
    title: 'Negative Aspect (Female)',
    type: 'array',
    of: [{type: 'block'}],
    group,
    description: 'Negative aspects specific to females of this energy type',
  },
  {
